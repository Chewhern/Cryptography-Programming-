...
Public Class Salt_Pepper_Byte
    Private Sub GoBTN_Click(sender As Object, e As EventArgs) Handles GoBTN.Click
        ...
        If PasswordString <> "" Then
            ...
            PepperByte = PasswordHash.ArgonGenerateSalt
            PepperBigInt = New BigInteger(PepperByte)
            SaltByte = PasswordHash.ArgonGenerateSalt
            SaltBigInt = New BigInteger(SaltByte)
            CombinedByte = PasswordByte.Concat(PepperByte).ToArray
            OutputLength = PasswordByte.Length + CombinedByte.Length
            HashedByte = PasswordHash.ArgonHashBinary(CombinedByte, SaltByte, PasswordHash.StrengthArgon.Moderate, OutputLength)
